...
1. First test account:
	- Username: testuser
	- Password: password123
2. Second test account:
	- Username: johndoe
...
#### Home Screen 
The home screen provides an overview of options the student can select to access their courses, progress tracking, calendar, and notifications.
